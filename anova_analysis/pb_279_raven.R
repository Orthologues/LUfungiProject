#this R script analyzes how different parameters affect results of BUSCO assessment for genome-assemblies of pb_279(Leuge)
...
raven=read.csv("pb_279_raven.csv")
str(raven) #check 
